 ...
 */
package edu.arizona.kra.sys.batch.batch;
...
import edu.arizona.kra.sys.batch.batch.bo.Step;
...
public class Job implements StatefulJob, InterruptableJob {
    ...
    public static boolean isPastCutoffWindow(Date date, Collection<String> runDates) {
        DateTimeService dTService = KraServiceLocator.getBean(DateTimeService.class);
        ParameterService parameterService = KraServiceLocator.getBean(ParameterService.class);
