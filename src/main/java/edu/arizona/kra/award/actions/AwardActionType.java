...
/**
 * A Award Action Type refers to the type of actions that an
 * that can be performed against a Award document.
 */
@SuppressWarnings("serial")
public class AwardActionType extends AwardActionTypeBase {

	public static final String AWARD_CREATED = "100";
