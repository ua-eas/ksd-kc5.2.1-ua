...
public class ProtocolOnlineReviewDaoOjb extends LookupDaoOjb implements OjbCollectionAware, ProtocolOnlineReviewDao {
    ...
    public List<ProtocolOnlineReviewBase> getCustomSearchResults(Map<String, String> fieldValues) {
        ...
        /// Process Query1
        criteria1.addLike("UPPER(reviewerApproved)", "Y");
        criteria1.addLike("UPPER(adminAccepted)", "Y");
        criteria1.addLike("UPPER(protocolOnlineReviewStatusCode)", "F");
        ...
        /// Process Query2
        criteria2.addNotLike("UPPER(protocolOnlineReviewStatusCode)", "F");
