...
public class PdfConstants {
    ...
    public static final String WORKBOOK_TEMPLATE_PATH = "workbook.template.file.path";
    public static final String WORKBOOK_OUTPUT_PATH = "workbook.output.file.path";
    public static final String WORKBOOK_TAB_NAME = "workbook.tab.name";
    public static final String WORKBOOK_START_ROW = "workbook.sheet.start.row";
    public static final String SHOULD_CREATE_SHEET = "create.excel.spreadsheet";
    public static final String EFS_BUCKET_SIZE = "efs.bucket.size";
    public static final String SHOULD_CREATE_EFS_FILES = "create.efs.files";
