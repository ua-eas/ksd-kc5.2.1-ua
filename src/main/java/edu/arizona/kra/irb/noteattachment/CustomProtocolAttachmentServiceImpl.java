...
/** UofA Customized implementation of {@link ProtocolAttachmentService ProtocolNoteAndAttachmentService}. */
public class CustomProtocolAttachmentServiceImpl extends ProtocolAttachmentServiceImpl implements ProtocolAttachmentService {

    public CustomProtocolAttachmentServiceImpl(BusinessObjectService boService, ProtocolDao protocolDao) {
