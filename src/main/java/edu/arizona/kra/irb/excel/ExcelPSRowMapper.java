...
public class ExcelPSRowMapper implements RowMapper<ExcelSummaryRecord> {
    @Override
    public ExcelSummaryRecord mapRow(ResultSet rs, int rowNum) throws SQLException {
        ExcelSummaryRecord record = new ExcelSummaryRecord();
