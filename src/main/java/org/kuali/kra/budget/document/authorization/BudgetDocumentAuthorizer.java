...
/**
 * This class is the Budget Document Authorizer. It determines the edit modes and document actions for all budget
 * documents.
 */
public class BudgetDocumentAuthorizer extends KcTransactionalDocumentAuthorizerBase {

	/**
	 * @see org.kuali.rice.kns.document.authorization.TransactionalDocumentAuthorizer#getEditModes(org.kuali.rice.krad.document.Document,
	...
	/**
	 * Set the permissions to be used during the creation of the web pages. The JSP files can access the editModeMap
	 * (editingMode) to determine what to display to the user. For example, a JSP file may contain the following:
	 * 
	 * <kra:section permission="modifyProposal"> . . . </kra:section>
	 * 
	 * In the above example, the contents are only rendered if the user is allowed to modify the proposal. Note that
	 * permissions are always signified as either TRUE or FALSE.
	 * 
	 * @param username
	...
	/**
	 * @see org.kuali.rice.kns.document.authorization.DocumentAuthorizer#canInitiate(java.lang.String,
	...
	/**
	 * @see org.kuali.rice.kns.document.authorization.DocumentAuthorizer#canOpen(org.kuali.rice.krad.document.Document,
	 *      org.kuali.rice.kim.api.identity.Person)
	 */
	...
	/**
	 * @see org.kuali.kra.authorization.KcTransactionalDocumentAuthorizerBase#canEdit(org.kuali.rice.krad.document.Document,
	 *      org.kuali.rice.kim.api.identity.Person)
	 */
	@Override
	...
	/**
	 * @see org.kuali.kra.authorization.KcTransactionalDocumentAuthorizerBase#canSave(org.kuali.rice.krad.document.Document,
	 *      org.kuali.rice.kim.api.identity.Person)
	 */
	@Override
	...
	/**
	 * @see org.kuali.kra.authorization.KcTransactionalDocumentAuthorizerBase#canCancel(org.kuali.rice.krad.document.Document,
	 *      org.kuali.rice.kim.api.identity.Person)
	 */
	@Override
	...
	/**
	 * @see org.kuali.kra.authorization.KcTransactionalDocumentAuthorizerBase#canReload(org.kuali.rice.krad.document.Document,
	 *      org.kuali.rice.kim.api.identity.Person)
	 */
	@Override
	...
	/**
	 * @see org.kuali.kra.authorization.KcTransactionalDocumentAuthorizerBase#canRoute(org.kuali.rice.krad.document.Document,
	 *      org.kuali.rice.kim.api.identity.Person)
	 */
	@Override
	...
	/**
	 * @see org.kuali.kra.authorization.KcTransactionalDocumentAuthorizerBase#canCopy(org.kuali.rice.krad.document.Document,
	 *      org.kuali.rice.kim.api.identity.Person)
	 */
	@Override
	...
	/**
	 * 
	 * Checks to see if the parent document has a valid workflow document(loaded from rice, not ojb) as some authorizers
	 * must check the parent docs workflow permssion.
	 * 
	 * @param budgetDocument
	 */
