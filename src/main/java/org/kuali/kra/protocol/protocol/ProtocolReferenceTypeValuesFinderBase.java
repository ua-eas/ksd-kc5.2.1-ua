...
public abstract class ProtocolReferenceTypeValuesFinderBase extends
	...
	/**
	 * Constructs the list of ProtocolBase Types. Each entry in the list is a
	...
	public List<KeyValue> getKeyValues() {
		...
		Collection protocolReferenceTypes = keyValuesService.findAllOrderBy(
				getProtocolReferenceTypeBOClassHook(),
		...
		for (Iterator iter = protocolReferenceTypes.iterator(); iter.hasNext();) {
			ProtocolReferenceTypeBase protocolReferenceType = (ProtocolReferenceTypeBase) iter
					.next();
