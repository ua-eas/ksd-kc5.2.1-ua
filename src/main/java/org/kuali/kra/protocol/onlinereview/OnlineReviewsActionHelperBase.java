...
public abstract class OnlineReviewsActionHelperBase implements Serializable {
        ...
        if (!initComplete || force) {
            ...
            if (currentSubmission != null) {
                ...
                if ( LOG.isDebugEnabled()) {
                    LOG.debug("OnlineReviewsActionHelperBase:init -> protocolDocument.getProtocol()= " + protocolDocument.getProtocol() + "inside init after SETTING protocolOnlineReviewDocuments=" + (protocolOnlineReviewDocuments == null ? "NULL" : protocolOnlineReviewDocuments.size()));
                }
    ...
    public List<ProtocolOnlineReviewDocumentBase> getProtocolOnlineReviewsForCurrentSubmission() {
        if ( LOG.isDebugEnabled()) {
            LOG.debug("getProtocolOnlineReviewsForCurrentSubmission() list=" + (protocolOnlineReviewDocuments == null ? "NULL" : protocolOnlineReviewDocuments.size()));
        }
