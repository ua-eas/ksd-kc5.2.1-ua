...
public class NegotiationActivity extends KraPersistableBusinessObjectBase {
	...
	/**
	 * Calculates the number of days between the start date and either the end date when available or the current date.
	 * 
	 * @return
	 */
	...
	/**
	 * 
	 * This method Calculates the number of days between the start date and either the end date when available or the
	 * current date.
	 * 
	 * @param startDate
	 * @param endDate
	...
	/**
	 * This method should be called during the execute or before save to update this BOs last updated by fields when
