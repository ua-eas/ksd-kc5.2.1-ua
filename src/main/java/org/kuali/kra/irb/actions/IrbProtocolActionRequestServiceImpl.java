...
public class IrbProtocolActionRequestServiceImpl extends ProtocolActionRequestServiceImpl implements IrbProtocolActionRequestService {
    ...
    private static Map<String, String> motionTypeMap;
    static{
    	motionTypeMap = new HashMap<String, String>();
    	motionTypeMap.put("1", "Approve Action");
    	motionTypeMap.put("2", "Disapprove");
    	motionTypeMap.put("3", "Return for Specific Minor Revisions");
    	motionTypeMap.put("4", "Return for Substantive Revisions Required");
    }
    ...
    private ProtocolRequestBean getProtocolRequestBean(ProtocolForm protocolForm, String taskName) {
        ...
        org.kuali.kra.protocol.actions.ProtocolActionBean protocolActionBean = getActionBean(protocolForm, taskName);
