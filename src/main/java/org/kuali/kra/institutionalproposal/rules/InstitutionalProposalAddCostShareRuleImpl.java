...
public class InstitutionalProposalAddCostShareRuleImpl extends CostShareRuleResearchDocumentBase implements
	...
	/**
	 * 
	 * @see org.kuali.kra.institutionalproposal.rules.InstitutionalProposalAddCostShareRule#processInstitutionalProposalCostShareBusinessRules(org.kuali.kra.institutionalproposal.rules.InstitutionalProposalAddCostShareRuleEvent,
	 *      int)
	 */
	...
	/*
	 * private String getProjectPeriodLabel() { String label =
	 * KraServiceLocator.getService(CostShareService.class).getCostShareLabel(); return label; }
	 */
