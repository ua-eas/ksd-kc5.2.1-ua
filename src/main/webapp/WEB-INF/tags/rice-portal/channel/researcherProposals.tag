...
<div class="body">
	<ul class="chan">
		...
		<li><portal:portalLink displayTitle="false" title="All My Proposals" url="${ConfigProperties.application.url}/kr/lookup.do?methodToCall=start&businessObjectClassName=org.kuali.kra.proposaldevelopment.bo.DevelopmentProposal&docFormKey=88888888&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true">All My Proposals</portal:portalLink></li>
