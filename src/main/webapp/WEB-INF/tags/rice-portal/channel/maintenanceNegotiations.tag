...
<div class="body">
  <ul class="chan">
    ...
    <li><portal:portalLink displayTitle="true" title="Negotiation Log" url="${ConfigProperties.application.url}/kr/lookup.do?methodToCall=start&businessObjectClassName=edu.arizona.kra.institutionalproposal.negotiationlog.NegotiationLog&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true&docFormKey=88888888" /></li>
  </ul>
</div>
