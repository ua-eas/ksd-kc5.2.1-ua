...
public class ActiveCommitteeMemberOnProtocolDerivedRoleTypeServiceTest {
    ...
    public void testHasApplicationRole() {
        ...
        String principalId = PersonFixture.UAR_TEST_005.getPrincipalId();
    ...
    private Committee createCommittee() {
        ...
        members.add(createCommitteeMember(PersonFixture.UAR_TEST_004.getPrincipalId(), PersonFixture.UAR_TEST_004.getPrincipalName()));
        members.add(createCommitteeMember(PersonFixture.UAR_TEST_005.getPrincipalId(), PersonFixture.UAR_TEST_005.getPrincipalName()));
        members.add(createCommitteeMember(PersonFixture.UAR_TEST_006.getPrincipalId(), PersonFixture.UAR_TEST_006.getPrincipalName()));
        members.add(createCommitteeMember(PersonFixture.UAR_TEST_007.getPrincipalId(), PersonFixture.UAR_TEST_007.getPrincipalName()));
        members.add(createCommitteeMember(PersonFixture.UAR_TEST_008.getPrincipalId(), PersonFixture.UAR_TEST_008.getPrincipalName()));
