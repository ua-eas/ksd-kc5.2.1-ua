...
public enum ProposalPersonFixture {
    PRINCIPAL_INVESTIGATOR(PersonFixture.UAR_TEST_003.getPrincipalId(), PRINCIPAL_INVESTIGATOR_ROLE),
    
    /**
     * Fully valid Principal Investigator with all the right valid stuff except no certifications.
     */
    INCOMPLETE_CERTIFICATIONS(PersonFixture.UAR_TEST_003.getPrincipalId(), PRINCIPAL_INVESTIGATOR_ROLE) {
        /**
     ...
     */
    INVESTIGATOR_SPLIT_ADDS_TO_ONE_HUNDRED(PersonFixture.UAR_TEST_003.getPrincipalId(), PRINCIPAL_INVESTIGATOR_ROLE) {
     ...
     */
    INVESTIGATOR_UNIT_NOT_TO_ONE_HUNDRED(PersonFixture.UAR_TEST_003.getPrincipalId(), PRINCIPAL_INVESTIGATOR_ROLE) {
     ...
     * Fully valid Principal Investigator with valid credit splits adding to a hundred and invalid lead unit
     */
    INVESTIGATOR_OVER_ONE_HUNDRED(PersonFixture.UAR_TEST_003.getPrincipalId(), PRINCIPAL_INVESTIGATOR_ROLE) {
     ...
     */
    INVESTIGATOR_UNDER_ZERO(PersonFixture.UAR_TEST_003.getPrincipalId(), PRINCIPAL_INVESTIGATOR_ROLE) {
     ...
     */
    INVESTIGATOR_UNIT_OVER_ONE_HUNDRED(PersonFixture.UAR_TEST_003.getPrincipalId(), PRINCIPAL_INVESTIGATOR_ROLE) {
     ...
     * Fully valid Principal Investigator with valid credit splits adding to a hundred and invalid lead unit
     */
    INVESTIGATOR_UNIT_UNDER_ZERO(PersonFixture.UAR_TEST_003.getPrincipalId(), PRINCIPAL_INVESTIGATOR_ROLE) {
    ...
    JTESTER_CO_INVESTIGATOR(PersonFixture.UAR_TEST_001.getPrincipalId(), CO_INVESTIGATOR_ROLE),
    WOODS_CO_INVESTIGATOR(PersonFixture.UAR_TEST_005.getPrincipalId(), CO_INVESTIGATOR_ROLE),
    OBLOOD_KEY_PERSON(PersonFixture.UAR_TEST_006.getPrincipalId(), KEY_PERSON_ROLE);
