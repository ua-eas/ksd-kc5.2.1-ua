...
public class QuickStartUserLookupTest extends KcUnitTestBase {
    ...
    public void testFindingQuickstartUser_TruncatedUserId() throws Exception {
        Person user = KEWServiceLocator.getIdentityHelperService().getPersonByPrincipalName("askdkjasdh");
    ...
    public void testFindingQuickstartUser_CompleteUserId() throws Exception {
        Person user = KEWServiceLocator.getIdentityHelperService().getPersonByPrincipalName(PersonFixture.UAR_TEST_001.getPrincipalName());
