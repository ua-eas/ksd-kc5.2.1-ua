...
public class BudgetPersonServiceTest extends KcUnitTestBase{
    ...
    public void setUp() throws Exception {
        ...
        quickstart = kcPersonService.getKcPersonByUserName(PersonFixture.UAR_TEST_001.getPrincipalName());
    ...
    public void testAddBudgetPersonWithAppointments() throws Exception {
        ...
        KcPerson person = kcPersonService.getKcPersonByPersonId(PersonFixture.UAR_TEST_001.getPrincipalId());
        testPerson.setPersonId(PersonFixture.UAR_TEST_001.getPrincipalId());
