...
public class KcNotificationServiceTest extends KcUnitTestBase {
    ...
    private static final String PRINCIPAL_ID_VALUE_CHEW = PersonFixture.UAR_TEST_009.getPrincipalId();
    private static final String PRINCIPAL_NAME_VALUE_JTESTER = PersonFixture.UAR_TEST_002.getPrincipalName();
    private static final String PRINCIPAL_NAME_VALUE_MAJORS = PersonFixture.UAR_TEST_010.getPrincipalName();
