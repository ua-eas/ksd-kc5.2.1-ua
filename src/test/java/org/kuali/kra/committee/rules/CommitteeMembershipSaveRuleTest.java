...
public class CommitteeMembershipSaveRuleTest extends CommitteeRuleTestBase {
    ...
    public void testSaveWithInvalidTermDate() throws Exception {
         ...
         */
        committeeMembership = createMembership(PersonFixture.UAR_TEST_002.getPrincipalName(), null, "1", "2009-01-15", "2009-01-14");
    ...
    public void testSaveWithRoleDatesOutsideTerm() throws Exception {
         ...
         * Create a committee membership with role and expertise.
         */
        committeeMembership = createMembership(PersonFixture.UAR_TEST_002.getPrincipalName(), null, "1", "2009-01-10", "2009-01-20");
    ...
    public void testSaveWithOverlappingMembership() throws Exception {
         ...
         */
        committeeMembership = createMembership(PersonFixture.UAR_TEST_002.getPrincipalName(), null, "1", "2009-01-10", "2009-01-15");
    ...
    public void testValidSave() throws Exception {
         ...
         */
        committeeMembership = createMembership(PersonFixture.UAR_TEST_002.getPrincipalName(), null, "1", "2009-01-01", "2009-01-10");
        ...
        committeeMembership = createMembership(PersonFixture.UAR_TEST_002.getPrincipalName(), null, "1", "2009-01-11", "2009-01-20");
