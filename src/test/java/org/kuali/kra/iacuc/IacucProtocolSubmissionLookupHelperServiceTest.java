...
public class IacucProtocolSubmissionLookupHelperServiceTest extends KcUnitTestBase {
    ...
    private static final String PERSON_INQ_URL ="inquiry.do?businessObjectClassName=org.kuali.kra.bo.KcPerson&personId="+ PersonFixture.UAR_TEST_001.getPrincipalId() +"&methodToCall=start";
    ...
    private IacucProtocolSubmission initProtocolSubmission() {
        ...
        protocol.setPrincipalInvestigatorId(PersonFixture.UAR_TEST_001.getPrincipalId());
        IacucProtocolPerson protocolPerson = new IacucProtocolPerson();
        protocolPerson.setPersonId(PersonFixture.UAR_TEST_001.getPrincipalId());
