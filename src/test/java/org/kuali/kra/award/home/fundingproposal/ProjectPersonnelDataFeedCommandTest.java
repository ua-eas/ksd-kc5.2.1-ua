...
public class ProjectPersonnelDataFeedCommandTest extends BaseDataFeedCommandTest {
    ...
    public void testFeedNewAward() {
        InstitutionalProposalPerson ipPerson1 = generateIPPerson(PersonFixture.UAR_TEST_001.getPrincipalId(), "Number 1", ContactRole.PI_CODE, new KualiDecimal(50.00));
        ipPerson1.add(generateIPUnit(unit1, true, new KualiDecimal(100.00)));
        InstitutionalProposalPerson ipPerson2 = generateIPPerson(PersonFixture.UAR_TEST_002.getPrincipalId(), "Number 2", ContactRole.COI_CODE, new KualiDecimal(50.00));
    ...
    public void testTypicalMerge() {
        ...
        proposal.add(ipPerson1);
        proposal.add(ipPerson2);
        AwardPerson awardPerson1 = generateAwardPerson(PersonFixture.UAR_TEST_003.getPrincipalId(), "Number 3", ContactRole.PI_CODE, new KualiDecimal(80.00));
        awardPerson1.add(generateAwardUnit(unit1, true, new KualiDecimal(100.00)));
        AwardPerson awardPerson2 = generateAwardPerson(PersonFixture.UAR_TEST_002.getPrincipalId(), "Number 2", ContactRole.COI_CODE, new KualiDecimal(20.00));
    ...
    public void testDuplicateMerge() {
        ...
        ipPerson1.add(generateIPUnit(unit1, true, new KualiDecimal(100.00)));
        proposal.add(ipPerson1);
        AwardPerson awardPerson1 = generateAwardPerson(PersonFixture.UAR_TEST_001.getPrincipalId(), "Number 1", ContactRole.PI_CODE, new KualiDecimal(50.00));
        awardPerson1.add(generateAwardUnit(unit1, true, new KualiDecimal(100.00)));
        award.add(awardPerson1);
        ProjectPersonnelDataFeedCommand command = new ProjectPersonnelDataFeedCommand(award, proposal, FundingProposalMergeType.MERGE);
        command.performDataFeed();
    ...
    public void testTypicalReplace() {
        ...
        ipPerson1.add(generateIPUnit(unit1, true, new KualiDecimal(100.00)));
        proposal.add(ipPerson1);
        AwardPerson awardPerson1 = generateAwardPerson(PersonFixture.UAR_TEST_003.getPrincipalId(), "Number 1", ContactRole.PI_CODE, new KualiDecimal(50.00));
        awardPerson1.add(generateAwardUnit(unit1, true, new KualiDecimal(100.00)));
        award.add(awardPerson1);
    ...
    public void testNoSplitReplace() {
        InstitutionalProposalPerson ipPerson1 = generateIPPerson(PersonFixture.UAR_TEST_001.getPrincipalId(), "Number 1", ContactRole.PI_CODE, null);
        ipPerson1.add(generateIPUnit(unit1, true, null));
        InstitutionalProposalPerson  ipPerson2 = generateIPPerson(PersonFixture.UAR_TEST_002.getPrincipalId(), "Number 2", ContactRole.COI_CODE, null);
