...
public class KcPersonServiceImplTest extends KcUnitTestBase {
    ...
    public void testGetKcPersonByUserName() {
        String userName = PersonFixture.UAR_TEST_001.getPrincipalName();
    ...
    public void testGetKcPersonByPersonId() {
        String personID = PersonFixture.UAR_TEST_002.getPrincipalId();
        String expectedUserName = PersonFixture.UAR_TEST_002.getPrincipalName();
