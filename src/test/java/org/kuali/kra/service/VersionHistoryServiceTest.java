...
public class VersionHistoryServiceTest {
    ...
    public void testFindingNewVersionHistory_OneAdded() {
        createAndCheckNewActiveVersion(sequenceOwner1, PersonFixture.UAR_TEST_002.getPrincipalName());
        checkOwner(SEQUENCE_OWNER_NAME_A, SequenceOwnerImpl.class, 1, 1001, PersonFixture.UAR_TEST_002.getPrincipalName());
    }
