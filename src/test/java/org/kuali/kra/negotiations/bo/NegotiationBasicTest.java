...
public class NegotiationBasicTest extends KcUnitTestBase {
    ...
    protected Negotiation getNewNegotiation() {
        ...
        negotiation.setNegotiatorName(PersonFixture.UAR_TEST_001.getPrincipalName());
    ...
    public void testNegotiationUnassociatedDetail() throws Exception {
        ...
        detail.setPiPersonId(PersonFixture.UAR_TEST_001.getPrincipalId());
    ...
    public void testActivities() {
        ...
        activity.setLastModifiedUsername(PersonFixture.UAR_TEST_001.getPrincipalName());
