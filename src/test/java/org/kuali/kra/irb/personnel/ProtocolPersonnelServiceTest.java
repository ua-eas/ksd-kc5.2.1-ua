...
public class ProtocolPersonnelServiceTest extends KcUnitTestBase {
    protected static final String CO_INVESTIGATOR_PERSON_ID = PersonFixture.UAR_TEST_003.getPrincipalId();
    protected static final String CO_INVESTIGATOR_NAME = PersonFixture.UAR_TEST_002.getPrincipalName();
    ...
    protected static final String PRINCIPAL_INVESTIGATOR_PERSON_ID = PersonFixture.UAR_TEST_001.getPrincipalId();
    protected static final String PRINCIPAL_INVESTIGATOR_NAME = PersonFixture.UAR_TEST_001.getPrincipalName();
