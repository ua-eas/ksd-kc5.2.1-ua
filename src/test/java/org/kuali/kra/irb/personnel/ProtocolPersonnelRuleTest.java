...
public class ProtocolPersonnelRuleTest extends ProtocolRuleTestBase {
    ...
    private static final String CO_INVESTIGATOR_PERSON_ID = PersonFixture.UAR_TEST_003.getPrincipalId();
    private static final String CO_INVESTIGATOR_NAME = PersonFixture.UAR_TEST_003.getPrincipalName();
