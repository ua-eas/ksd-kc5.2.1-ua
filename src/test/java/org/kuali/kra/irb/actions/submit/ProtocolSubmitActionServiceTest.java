...
public class ProtocolSubmitActionServiceTest extends KcUnitTestBase {
    ...
    private List<ProtocolReviewerBean> getDefaultReviewers() {
        ...
        Principal prncpl = identityManagementService.getPrincipalByPrincipalName(PersonFixture.UAR_TEST_001.getPrincipalName());
        ...
        prncpl = identityManagementService.getPrincipalByPrincipalName(PersonFixture.UAR_TEST_010.getPrincipalName());
        reviewer.setPersonId(prncpl.getPrincipalId());
        reviewer.setNonEmployeeFlag(false);
        reviewer.setReviewerTypeCode("1");
        reviewer.setFullName(prncpl.getPrincipalName());
        ...
        reviewer = new ProtocolReviewerBean();
        Principal coPi = identityManagementService.getPrincipalByPrincipalName(PersonFixture.UAR_TEST_002.getPrincipalName());
        reviewer.setNonEmployeeFlag(false);
